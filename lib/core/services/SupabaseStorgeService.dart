...
static CreatBucket(String nameBucket) async{
  ...
  Future<String> UploadFile(File file, String path) async{
   ...
   var result=  _supabase.client.storage.from(BackEndImpoint.fruits_imageBucket).upload('$path/$filename.$fileExtintin', file);
    final String publicUrl = await _supabase.client
        .storage
