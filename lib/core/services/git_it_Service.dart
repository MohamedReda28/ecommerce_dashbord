...
void setupGitit() {
   ...
   getIt.registerSingleton<ImageRepo>(ImageRepoImplement(getIt.get<StorgeService>()));
   getIt.registerSingleton<ProductRepo>(ProductRepoImplement(getIt.get<DataBaseServeces>()));
